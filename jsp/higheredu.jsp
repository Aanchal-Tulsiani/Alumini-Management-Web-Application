...
body,html {
    ...
    /*     Higher Education     */
        ...
        /*        Add card for higher education button   */
        .add_edu_info {
            text-decoration: none;
            font-size: 1vw;
            color: white;
...
<body>
 <%
	...
	<%
		...
		%>
<form action="eduedit.jsp" method="post">
      <div style="margin-left:300px;">
        <div class="column">
          <div class="card">
            <p><span class="edu_info">Degree</span><span class="edu_info_detail"><%=h.getDegree()%></span></p><br>
            <p><span class="edu_info">University</span><span class="edu_info_detail"><%=h.getUniversity()%></span></p><br>
            <p><span class="edu_info">Start date</span><span class="edu_info_detail"><%=h.getStartDate()%></span></p><br>
            <p><span class="edu_info">End date</span><span class="edu_info_detail"><%=h.getEndDate()%></span></p><br>

            <button type="submit" class="edit_edu_info" name="edu" value=<%=ar.get(i)%>>Edit</button>
		  </div>
	    </div>
	  </div>
	  </form>
   ...
   <a href="addEduForm.jsp" class="add_edu_info">add new Higher Education</a>
