 ...
 <%
    ...
    <div class="top_nav">
        <div style="margin:0vw 12vw 0vw -6vw;">
                    ...
                    <b><p style="float: right; margin: 9px 10px 0px 0px;">Hey <%=name %></p></b>
    </div>
	...
	<div class="carousel">
		<img class="carousel_img dsiplay_1"
			src="https://www.entrancezone.com/engineering/wp-content/uploads/2016/10/LNMIIT-2017-1.jpg"> <img
			class="carousel_img dsiplay_2" src="img2.jpg"
			style="display: none;"> <img class="carousel_img dsiplay_3"
			src="img3.jpg" style="display: none;">
	</div>
	<!-- <div class="carousel_selector">
		<a class="img_1" href="#">1</a> <a class="img_2" href="#">2</a> <a
			class="img_3" href="#">3</a>
	</div> -->

	<div class="info_container">
		<p class="info_heading">About LNMIIT</p>
		<P class="info_details">Founded in 2011, the LNMIIT Alumni
			Association has been ever since connecting alumni all over the world
			by organizing Chapter meets in various cities across the globe, and
			the Alumni Meet in the LNMIIT campus. The primary mission of the
			LNMIIT Alumni Association is to reconnect the alumni with their
			fellow alumni with various Chapter Meets across the globe, institute
			with Alumni meet, and students on the campus with interactive
			sessions and online video sessions- engage through various activities
			among all the stakeholders- to generate impact through several social
			and academic projects for a collective growth.</P>
	</div>

	<div class="footer">
		<a class="foot_notes" href="home.jsp"> Home </a> 
		<a class="foot_notes" href="contactUs.jsp"> Contact Us </a>
	</div>
