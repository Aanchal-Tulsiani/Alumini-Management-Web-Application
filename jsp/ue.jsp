...
<body>
 <%
	...
	<form method="post" action="comfirm.jsp">
		...
		<div class="w3-container" style="width: 100%">
			...
			<div class="w3-card-4" style="width: 100%">
				...
				<%-- <input type="text" name="${resultSet.getInt("e_id")}" value="${resultSet.getInt("e_id")}"> --%>
				<%
				/* session.setAttribute("Eid",resultSet.getInt("e_id")); */
		...
		try {
			...
			st1 = connection.createStatement();
				...
				String sql2="select * from participation,alumini where participation.alumini_id=alumini.aid and name='"+name+"' and event_id="+ar.get(i)+";" ;
			...
			%>
				...
				<button class="w3-button w3-block w3-dark-grey" type="submit" name="bt" value=<%=ar.get(i)%>>Register for the Event</button>
